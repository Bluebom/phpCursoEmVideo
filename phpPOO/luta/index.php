...
<body>
  ...
  $lutadores[3] = new Lutador("Dead Code", "Austrália", 28, 1.93, 81.9, 13, 0, 2);
  $lutadores[4] = new Lutador("UFOCobol", "Brasil", 37, 1.70, 119.7, 5, 4, 3);
  $lutadores[5] = new Lutador("NerdaArt", "EUS", 30, 1.81, 105.7, 12, 2, 4);
  $UEC01 = new Luta();
